...
- **VPS source path:** `/etc/dokploy/applications/app-calculate-mobile-alarm-ejm6t8/code`
- **Public URL:** https://joberator.grooveops.dev
- **Logs:** `ssh main-instance "docker logs app-calculate-mobile-alarm-ejm6t8"`
